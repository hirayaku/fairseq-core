...
def infer_init_method(cfg: DistributedTrainingConfig, force_distributed=False):
    ...
    if cfg.distributed_port > 0:
        ...
        # hth: change of behavior here. We use distribute_main even when world_size = 1.
        # Set world_size = 0 to disable distribute_main.
    ...
    if cfg.distributed_training.distributed_init_method is not None:
        ...
        if not cfg.distributed_training.distributed_no_spawn:
            ...
            torch.multiprocessing.spawn(
                ...
                # hth NOTE: launch processes for distributed training and inference;
                # the flag `--distributed_world_size` decides the world size.
                # world size also impacts the loading and initialization of the model which happens later.
                nprocs=min(
