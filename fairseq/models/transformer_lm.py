...
class TransformerLanguageModelConfig(FairseqDataclass):
    ...
    moe_skip_init: bool = field(
        default=True,
        metadata={
            "help": "Skip initialization of the expert FFNs to accelerate loading"
        },
    )
    moe_freq: int = field(
        default=0,
...
class TransformerLanguageModel(FairseqLanguageModel):
    ...
    def build_model(cls, args, task):
        ...
        if args.character_embeddings:
            ...
            # hth: we don't need this; disable the code path for now
            assert False, "args.adaptive_input is True"
